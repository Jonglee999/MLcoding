...
plt.style.use(
    '../../../../学习笔记/2022-Machine-Learning-Specialization-main/Advanced Learning Algorithms/week2/9.Practice Lab Neural network training/deeplearning.mplstyle')


def load_data():
    X = np.load(
        "D:\\pycharmprojs\\pythonlearning\\MLlearning\\C2W1handwritingrecg\\X.npy")
    y = np.load(
        "D:\\pycharmprojs\\pythonlearning\\MLlearning\\C2W1handwritingrecg\\y.npy")
    return X, y
